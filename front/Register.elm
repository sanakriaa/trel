...
update msg model =
    case msg of
        ...
        FirstNameUpdated first_name ->
            ( { model | first_name = first_name }, Cmd.none )

        LastNameUpdated last_name ->
...
view model =
    Html.form [ action "/register", method "POST", class "register-form" ]
        ...
        , label []
            [ text "First Name: "
            , input [ name "first_name", type_ "text", onInput FirstNameUpdated ]
                []
            ]
        , label []
            [ text "Last Name: "
            , input [ name "last_name", type_ "text", onInput LastNameUpdated ]
                []
            ]    
        , label []
            [ text "Password: "
