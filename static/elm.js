...
var author$project$Register$initialModel = {email: '', emailStatus: author$project$Register$NotAnEmail, first_name: '', last_name: '', password1: '', password2: '', passwordCheck: author$project$Register$Password1NotDone};
...
var author$project$Register$PasswordsMismatch = {$: 'PasswordsMismatch'};
...
var author$project$Register$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'EmailUpdated':
				var email = msg.a;
				return author$project$Register$isValidEmail(email) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{email: email, emailStatus: author$project$Register$Loading}),
					author$project$Register$getTestEmail(email)) : _Utils_Tuple2(
					_Utils_update(
						model,
						{email: email, emailStatus: author$project$Register$NotAnEmail}),
					elm$core$Platform$Cmd$none);
			case 'FirstNameUpdated':
				var first_name = msg.a;
			...
			case 'Password1Updated':
				...
				return _Utils_Tuple2(
					function () {
						var _n1 = model.passwordCheck;
						if (_n1.$ === 'Password1NotDone') {
							...
							return _Utils_update(
								...
								{
									password1: password1,
									passwordCheck: _Utils_eq(password1, model.password2) ? author$project$Register$PasswordsMatch : author$project$Register$PasswordsMismatch
								});
						}
					}(),
					elm$core$Platform$Cmd$none);
			case 'Password2Updated':
				var password2 = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							password2: password2,
							passwordCheck: _Utils_eq(password2, model.password1) ? author$project$Register$PasswordsMatch : author$project$Register$PasswordsMismatch
						}),
					elm$core$Platform$Cmd$none);
			default:
				if (msg.a.$ === 'Ok') {
					var testEmail = msg.a.a;
					return _Utils_Tuple2(
...
var author$project$Register$FirstNameUpdated = function (a) {
	return {$: 'FirstNameUpdated', a: a};
};
var author$project$Register$LastNameUpdated = function (a) {
	return {$: 'LastNameUpdated', a: a};
};
...
var author$project$Register$isFormValid = function (model) {
	return (model.first_name !== '') && ((model.last_name !== '') && ((model.password1 !== '') && (_Utils_eq(model.password1, model.password2) && _Utils_eq(model.emailStatus, author$project$Register$Free))));
};
...
var author$project$Register$viewEmailStatus = function (emailStatus) {
	switch (emailStatus.$) {
		case 'NotAnEmail':
			return A2(
				elm$html$Html$span,
...
var author$project$Register$viewPasswordCheck = function (passwordCheck) {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_Nil),
						author$project$Register$viewEmailStatus(model.emailStatus)
					])),
				A2(
				elm$html$Html$label,
				_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onInput(author$project$Register$FirstNameUpdated)
							]),
						_List_Nil)
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$type_('text'),
								elm$html$Html$Events$onInput(author$project$Register$LastNameUpdated)
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_Nil),
						author$project$Register$viewPasswordCheck(model.passwordCheck)
					])),
				A2(
				elm$html$Html$input,
				author$project$Register$isFormValid(model) ? _List_fromArray(
					[
						...
						elm$html$Html$Attributes$value('Register')
					]) : _List_fromArray(
					[
						elm$html$Html$Attributes$name(''),
						elm$html$Html$Attributes$type_('submit'),
...
var author$project$Main$decodeExternalPostlist = function (val) {
	var _n0 = A2(
	...
	if (_n0.$ === 'Ok') {
		var postlist = _n0.a;
		return author$project$Main$GotPosts(postlist);
	} else {
		var err = _n0.a;
...
var author$project$Main$User = F4(
	function (first_name, last_name, status, rowid) {
		return {first_name: first_name, last_name: last_name, rowid: rowid, status: status};
	});
...
var author$project$Main$postlistPort = _Platform_incomingPort('postlistPort', elm$json$Json$Decode$value);
		...
		switch (msg.$) {
			...
			case 'PostUpdated':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'PostSubmitted':
				return (model.newPost === '') ? _Utils_Tuple2(model, elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{newPost: ''}),
					elm$http$Http$post(
								...
								elm$json$Json$Encode$object(
									_List_fromArray(
										[
											_Utils_Tuple2(
											'content',
											elm$json$Json$Encode$string(model.newPost))
										]))),
...
var author$project$Main$PostSubmitted = {$: 'PostSubmitted'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('post-header')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('post-author')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$text('at ' + post.date)
							]))
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('post-content')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(post.content)
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('user-list')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('posts')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$action('/posts/'),
								elm$html$Html$Attributes$id('post-form'),
								elm$html$Html$Attributes$method('POST'),
								elm$html$Html$Events$onSubmit(author$project$Main$PostSubmitted)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$value(model.newPost),
										elm$html$Html$Attributes$type_('text'),
										elm$html$Html$Events$onInput(author$project$Main$PostUpdated)
									]),
								_List_Nil),
								A2(
								elm$html$Html$input,
